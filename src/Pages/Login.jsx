...
function handleCreateAccountClick() {
  ...
  return(
    <div>
    {showRegistration? (<div className="w-full h-screen font-sans bg-cover bg-[url('https://dm0qx8t0i9gc9.cloudfront.net/thumbnails/video/GTYSdDW/videoblocks-science-fiction-blue-checkerboard-motion-background-loop_sewdlggl0_thumbnail-1080_01.png')]">
      <div className="container flex items-center justify-center flex-1 h-full mx-auto">
        <div className="flex flex-col w-11/12 max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
          ...
          <span className="justify-center text-sm text-center text-gray-500 flex-items-center dark:text-gray-400" onClick={handleCreateAccountClick}>
    ...
    <div className="mt-8">
        <form onSubmit={handleSubmit} autoComplete="on">
            ...
            <div className="flex items-center justify-center mt-6">
                <a className="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white" onClick={handleCreateAccountClick}>
                    <span className="ml-2">
